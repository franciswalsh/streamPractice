...
public class Main {
    ...
    public static void printDurationGreaterThan10(List<Entry> entries){
        ...
        // write stream
        entries.stream().filter(entry -> entry.getDuration() > 10).forEach(entry -> System.out.println(entry));
        System.out.println();
    }
    ...
    public static void findMaxDuration(List<Entry> entries){
        ...
        temp = entries.stream().mapToInt(entry -> entry.getDuration()).max().getAsInt();
        System.out.println("The Max Duration is: " + temp);
        System.out.println();
    }
    ...
    public static void listGreaterThan50(List<Entry> entries){
        ...
        System.out.println("Stream, filter, collect:");
        // write stream
        entries.stream().filter(entry -> entry.getDuration() > 50).collect(Collectors.toList());
        System.out.println(greaterThan50);
        System.out.println();
    }
}
